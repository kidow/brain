...
## 모호한 단어를 정확한 단어로 (Precise Word Choice)

"good", "bad", "nice", "very", "a lot", "get", "do" 같은 **범용 단어**는 편해서 자꾸 쓰게 되는데, 뜻이 너무 넓어서 독자가 정확히 뭘 말하는지 못 느낌.

**강조부사(very, really, so) 남발:**

> ❌ "The results were very good."
> ✅ "The results were impressive." / "The results exceeded expectations."
...
> ✅ "We need to achieve/produce/generate better results."

**범용 형용사(good, bad, nice, big) 구체화:**

> ❌ "It was a big problem."
> ✅ "It was a costly/urgent/systemic problem." (문제의 정확히 어떤 측면이 큰지)
