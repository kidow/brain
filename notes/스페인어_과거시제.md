...
## pretérito + imperfecto 함께 쓰기: 배경 vs 사건

실제 이야기에서는 두 과거가 한 문장 안에서 같이 쓰임 — imperfecto가 배경(무엇이 진행 중이었는지), pretérito가 그 배경 위에 끼어든 사건.

| 문장 | 구조 |
|------|------|
| `Comía cuando sonó el teléfono.` | 먹고 있었다(배경) + 전화가 울렸다(사건) |
| `Era de noche cuando llegamos.` | 밤이었다(배경) + 우리가 도착했다(사건) |
| `Hablaba con Juan cuando entraste.` | 후안과 이야기 중이었다(배경) + 네가 들어왔다(사건) |
