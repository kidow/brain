...
## suppose / supposing / what if — 구어체 가정

격식 if 대신 가볍게 "만약 ~라면?"을 표현.

- Suppose you won the lottery, what would you do?
- Supposing it rains, should we cancel?
- What if we take a different route? (제안)
- What if he finds out? (우려)

suppose vs supposing: 의미 동일, 교환 가능. supposing이 약간 더 가설적·극적 느낌.
시제: 현재 가능성 → 현재형, 현재 비현실 → 과거형.
