...
to + 동사원형. 동사를 명사·형용사·부사로 변환하는 장치.

전치사 to vs to부정사 to:
- 전치사 to: 뒤에 명사 (go to school)
- to부정사 to: 뒤에 동사원형 (want to eat)

to부정사 3가지 역할:
- 명사적: ~하는 것, ~하기 (To sleep is important.)
- 형용사적: ~할, ~해야 할 (homework to do)
- 부사적: ~하기 위해, ~해서 (I study to learn.)
...
**② 목적어**: ~하기를
- I want to eat pizza.
- 목적어로 to부정사 받는 동사: want, decide, refuse, need, hope, plan, agree, promise, fail, expect
