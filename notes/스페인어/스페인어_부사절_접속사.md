...
## 불특정·존재하지 않는 대상 수식: busco algo que + 접속법

관계절(que절)이 특정되지 않았거나 존재 여부가 불확실한 대상을 수식하면 접속법을 씀 — 관계대명사(que)와 접속법 트리거의 결합.

| 문장 | 시제 | 뜻 |
|------|------|-----|
| `Busco un empleado que hable español.` | 접속법 | 스페인어 하는 직원을 찾는다(있을지 불확실) |
| `Conozco a un empleado que habla español.` | 직설법 | 스페인어 하는 직원을 안다(특정인, 확실히 존재) |
| `No hay nadie que sepa la respuesta.` | 접속법 | 답을 아는 사람이 아무도 없다(존재 부정) |
