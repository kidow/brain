...
| 항목 | Suno | Udio |
|------|------|------|
| 강점 | 구조·가사 제어, 팝/EDM 완성도 | 음질, 세밀한 장르 재현 |
| 스타일 레퍼런스 | 아티스트 이름 거부 경향 | 아티스트 이름 잘 수용 |
| 섹션 태그 | 잘 작동 | 지원하나 반응 약함 |
| 가사 제어 | 강력 | 덜 정밀 |
| 장르 폭 | 팝·EDM·힙합 강함 | 재즈·클래식·월드뮤직 강함 |

선택 기준:
- 가사 있는 팝/EDM 완성 → Suno
- 아티스트 사운드 재현, 고음질 기악 → Udio
- 같은 프롬프트로 둘 다 생성 후 비교도 유효
